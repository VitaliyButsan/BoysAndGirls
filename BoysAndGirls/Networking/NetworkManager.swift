...
class NetworkManager {
    ...
    func request(photoName: String, onPage: Int = 1, callBack: @escaping(Data?, URLResponse?, Error?) -> Void) {
        let parameters = self.prepareParameters(searchWord: photoName, onPage: onPage)
